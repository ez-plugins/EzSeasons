...
public final class ServerEnvironment {
    ...
    private static final boolean FOLIA =
            HAS_ASYNC_SCHEDULER || hasClass("io.papermc.paper.threadedregions.scheduler.AsyncScheduler");
    ...
    static {
        ...
        else if (hasClass("io.papermc.paper.util.TickThread")
                || hasClass("com.destroystokyo.paper.PaperVersionFetcher")) {
            BRAND = "Paper";
        }
        else {
            BRAND = Bukkit.getServer().getName(); // CraftBukkit/Bukkit/etc.
        }
    }
    ...
    public static boolean hasAsyncScheduler() {
        return HAS_ASYNC_SCHEDULER;
    }

    public static boolean hasGlobalRegionScheduler() {
        return HAS_GLOBAL_REGION_SCHEDULER;
    }
    ...
    private static boolean hasClass(String name) {
        try {
            Class.forName(name, false, ServerEnvironment.class.getClassLoader());
            return true;
        }
